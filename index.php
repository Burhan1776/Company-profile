...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">BURHAN GROUP</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5" src="img/burhan.png" alt="">

      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">BURHAN CREATOR</h1>
      ...
      <!-- Masthead Subheading -->
      <p class="masthead-subheading font-weight-light mb-0">Education - Learn - Ilustrator</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <img class="img-fluid" src="img/portfolio/icon web.png" alt="">
          </div>
        </div>
  ...
  <section class="page-section bg-primary text-white mb-0" id="about">
    <div class="container">
      ...
      <div class="text-center mt-4">
        <a class="btn btn-xl btn-outline-light" href="https://www.instagram.com/burhan8849/">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="form-group">
              <button type="submit" name="send" class="btn btn-primary btn-xl" id="sendMessageButton">Send</button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">RT/RW 01/04 KP.BOJONG DESA LAKSANA KEC. PAKUHAJI
            <br>KAB.TANGERANG</p>
        </div>
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <a class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/Burhan0696">
            <i class="fab fa-fw fa-facebook-f"></i>
          </a>
          <a class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/Burhan0696">
            <i class="fab fa-fw fa-twitter"></i>
          </a>
          <a class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/burhan-udin-a16496156/">
        ...
        <div class="col-lg-4">
          ...
          <p class="lead mb-0">Ini adalah web bentuk peraktek dalam pelajaran web progreming 1 di Universitas Raharja
            <a href="http://idu.raharja.info/enrolled_dashboard">Universitas Raharja</a>.</p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; Burhan Website 2019</small>
    </div>
    </form>
  </section>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <!-- Portfolio Modal - Text -->
                <p class="mb-5">Saya adalah Mahasiswa Universitas Raharja Semester 6 saat ini, saya mengambil jurusan
                  Sistem Informasi
                  Konsentrasi Business Intelligence saat ini saya sedang mengerjakan project dari salah satu matakuliah
                  yaitu Web progreming 1 mungkin dengan adanya
                  peraktek ini mahasiswa lebih tau banyak dalam pemograman dan pengembangan sistem informasi.</p>
                <button class="btn btn-primary" href="#" data-dismiss="modal">
                  <i class="fas fa-times fa-fw"></i>
                  Close Window
                </button>
